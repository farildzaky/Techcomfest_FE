...
const Hero = () => {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            .from(".hero-slider-container", {
                x: 60,
                opacity: 0,
                duration: 1.2,
                ease: "power3.out"
            }, "-=1.0")
            .from(".hero-box-doctor", {
                y: 60,
                opacity: 0,
                scale: 0.95,
                duration: 1,
            ...
            tlExit.to([".hero-title", ".hero-desc", ".hero-slider-container", ".hero-box-doctor", ".hero-box-counter"], {
                opacity: 0,
                y: -50,
                stagger: 0.5,
                ease: "power1.in"
            ...
            <div className="hero-slider-container w-[60%] flex items-center justify-center overflow-hidden relative h-full">
                ...
                >
                    <div className="flex items-center leading-none">
                        ...
                        <span
                            className={`font-bold text-[5vw] transition-all duration-1000 ease-out transform ${counter === number
