...
const CardMenu: React.FC<CardMenuProps> = ({ menu, day }) => {
    return (
        <div className="relative flex flex-col justify-center items-center w-full h-[20vw] lg:h-[11vw] rounded-[1vw] pt-[4vw] px-[1vw] pb-[4vw] bg-[#D7762E]">
            <div className='absolute top-[-3vw] lg:w-[6vw] lg:h-[6vw]  w-[8vw] h-[8vw] flex justify-center items-center text-black satoshiBold  text-[2.5vw] lg:text-[1.5vw] bg-[#FAF6E6] px-[0.5vw] rounded-full'
