        ...
        <div className="w-full min-h-screen p-[3vw] flex flex-col font-sans relative" onClick={() => setOpenDropdown(null)}>
                        ...
                        currentItems.map((item, index) => (
                            <div key={item.id} className={`flex border-b-[0.15vw] border-[#E87E2F] last:border-b-0 transition-colors ${(indexOfFirstItem + index) % 2 === 1 ? 'bg-[#FFF3EB]' : 'bg-white'
                                ...
                                <div className="w-[20%] px-[2vw] py-[1.5vw] flex justify-center items-center border-r-[0.15vw] border-[#E87E2F]">
                                    <span className={`${getStatusColor(item.status)} text-white satoshiBold text-[1vw] px-[2vw] py-[0.5vw] rounded-[1vw] shadow-sm w-full text-center`}>
                                        {item.status}
                                    </span>
                                </div>
                                <div className="w-[15%] py-[1.5vw] flex justify-center items-center">
                                    <button onClick={() => setSelectedItem(item)} className="text-[#D98848] underline satoshiMedium text-[1.2vw] hover:text-[#b06a33] cursor-pointer">
                                        Lihat Detail
                                    </button>
                                </div>
                            </div>
            ...
            {totalPages === 0 && (
                ...
                <div className="mt-[2vw] ">
                    <button
                        onClick={() => router.push('/sekolah/pelaporan/form-pelaporan')}
                        className="w-full bg-[#E87E2F] text-white satoshiBold text-[1.8vw] py-[1.2vw] rounded-[1.5vw] shadow-md hover:bg-[#b06a33] transition-colors cursor-pointer"
                    >
