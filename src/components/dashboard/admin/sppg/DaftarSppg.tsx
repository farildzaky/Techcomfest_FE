...
const DaftarSppgAdmin = () => {
    ...
    if (error) return (
        <div className="w-full h-screen flex flex-col justify-center items-center gap-[1vw]">
            <p className="text-red-500 satoshiBold text-[1.5vw]">{error}</p>
            <button onClick={() => window.location.reload()} className="bg-[#E87E2F] text-white px-[2vw] py-[0.5vw] rounded-[0.5vw]">Muat Ulang</button>
        </div>
    );
    ...
    return (
        <div className="w-full min-h-screen p-[3vw] font-sans relative" onClick={() => { setOpenRowId(null); setIsFilterOpen(false); }}>
            ...
            <div className="flex justify-between items-center mb-[2vw]">
                <h1 className="satoshiBold text-[2.5vw] text-black">SPPG</h1>
            ...
            <div className="w-full bg-[#E87E2F] rounded-[1.5vw] border-[0.2vw] border-[#E87E2F]">
                ...
                <div className="flex bg-[#E87E2F] text-white rounded-t-[1.3vw]">
                    ...
                    <div className="w-[30%] py-[1vw] flex justify-center items-center border-r-[0.15vw] border-white satoshiBold text-[1.5vw]">SPPG</div>
                    <div className="w-[25%] py-[1vw] flex justify-center items-center border-r-[0.15vw] border-white satoshiBold text-[1.5vw]">Jumlah Sekolah</div>
                ...
                <div className="flex flex-col bg-white rounded-b-[1.3vw]">
                    {loading ? (
                        Array.from({ length: itemsPerPage }).map((_, index) => (
                            <div key={index} className="flex border-b-[0.15vw] border-[#E87E2F] animate-pulse bg-white">
                            ...
                            return (
                                <div 
                                    ...
                                    className={`flex border-b-[0.15vw] border-[#E87E2F] transition-colors relative z-10 
                                        ...
                                        ${index === array.length - 1 ? 'last:border-b-0 rounded-b-[1.3vw]' : ''} 
                                    `}
                                ...
                                >
                                    ...
                                    <div className="w-[15%] py-[1.5vw] flex justify-center items-center">
                                        <Link href={`/admin/sppg/${item.id}`} className="text-[#D9833E] underline satoshiMedium text-[1.2vw] hover:text-[#b06a33]">
                                            Lihat Detail
                                        </Link>
                                    </div>
                                </div>
            ...
            <div className="flex justify-end mt-[1.5vw] items-center gap-[1vw]">
                <button 
                    ...
                    className={`w-[2vw] h-[2vw] flex items-center justify-center rounded-full border border-[#E87E2F] transition-colors ${currentPage === 1 ? 'bg-gray-200 text-gray-400 border-gray-300 cursor-not-allowed' : 'bg-white text-[#E87E2F] hover:bg-[#E87E2F] hover:text-white'}`}
                >
                    &lt;
                </button>
                ...
                <button 
                    ...
                    className={`w-[2vw] h-[2vw] flex items-center justify-center rounded-full border border-[#E87E2F] transition-colors ${currentPage === totalPages ? 'bg-gray-200 text-gray-400 border-gray-300 cursor-not-allowed' : 'bg-white text-[#E87E2F] hover:bg-[#E87E2F] hover:text-white'}`}
                >
                    &gt;
                </button>
            </div>
